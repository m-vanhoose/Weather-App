...
let citySearch = function(city) {
    ...
    fetch(requestUrl2)
        ...
        .then(function (data){
            ...
            day1.innerText = dayjs.unix(data.list[1].dt).format('MMMM D YYYY');
            let imgEl1 = document.createElement('img');
            imgEl1.src = 'http://openweathermap.org/img/wn/'+data.list[1].weather[0].icon+'@2x.png';
            day1.appendChild(imgEl1)
            let temp1 = document.getElementById('temp1');
            temp1.innerText = data.list[1].main.temp +' °F';
            let wind1 = document.getElementById('wind1');
            wind1.innerText = data.list[1].wind.speed +' MPH';
            let hum1 = document.getElementById('hum1');
            hum1.innerText = data.list[1].main.humidity +' %';

            let day2 = document.getElementById('day2');
            day2.innerText = dayjs.unix(data.list[9].dt).format('MMMM D YYYY');
            ...
            day3.innerText = dayjs.unix(data.list[17].dt).format('MMMM D YYYY');
            ...
            day4.innerText = dayjs.unix(data.list[25].dt).format('MMMM D YYYY');
            ...
            day5.innerText = dayjs.unix(data.list[33].dt).format('MMMM D YYYY');
